...
function VideoTitleCard() {
    return (
        <div className="max-w-sm mx-auto bg-white border border-slate-200 rounded-lg p-4">
            <div className="flex justify-end space-x-2">
                <button className="text-[#B4B4B4] hover:text-gray-600">
                    <TbEdit size={20} />
                </button>
            ...
            <div className="flex justify-between items-center">
                <h3 className="text-sm font-medium text-[#B4B4B4]">Video Title</h3>
