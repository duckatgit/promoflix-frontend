    ...
    >
      ...
      <div className="sidebar-content">
        <div className="p-2">
          ...
          >
            <span className="icon">
              <img src="/assets/billing-icon.png" alt="Pricing Plans Icon" />
            </span>
      ...
      <div className="border-b-2 border-[#D9D9D9] w-full">
        <div className="p-4">
          <div className="user-info ">
            <span className="avatar w-[35px] h-[35px] rounded-full bg-white border-[3px] border-[#f1c40f] text-center font-sans text-[18px] font-bold text-[#333] mr-2">
              {name?.charAt(0)}
            </span>
            <div className="text">
